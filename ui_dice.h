...
public:
    ...
    void setupUi(QDialog *dice)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(240, 60, 851, 151));
        ...
        btnStart->setGeometry(QRect(1210, 210, 181, 101));
        btnExit = new QPushButton(dice);
        btnExit->setObjectName("btnExit");
        btnExit->setGeometry(QRect(1210, 440, 181, 101));
        btnReset = new QPushButton(dice);
        btnReset->setObjectName("btnReset");
        btnReset->setGeometry(QRect(1210, 330, 181, 101));
        gridLayoutWidget_2 = new QWidget(dice);
        gridLayoutWidget_2->setObjectName("gridLayoutWidget_2");
        gridLayoutWidget_2->setGeometry(QRect(240, 510, 851, 151));
